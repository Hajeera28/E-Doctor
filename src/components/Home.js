...
<p>
At DoctorApp, we bring you exceptional healthcare services tailored to meet your 
unique needs. 
With an experienced team of professionals and state-of-the-art facilities, you can trust 
us to be with you 
...
<p>Our team consists of highly skilled professionals dedicated to providing the best 
care possible.</p>
</div>
<div className="feature-item">
<h4>🏥Advanced Facilities</h4>
<p>We use the latest technology and state-of-the-art equipment for accurate 
diagnosis and treatment.</p>
</div>
<div className="feature-item">
<h4>📞 24/7 Support</h4>
<p>Access our services anytime with our round-the-clock support team ready to 
assist you.</p>
</div>
</div>
</div>
{/* Key Features Section */}
<div className="key-features-section" style={{ marginTop: '50px', textAlign: 'center', 
padding: '20px' }}>
<h3 style={{ fontSize: '24px', marginBottom: '20px' }}>Key Features</h3>
<div className="key-features">
<div className="key-feature-item">
<h4>📱 Teleconsultation</h4>
<p>Connect with your doctor from the comfort of your home through video or voice 
calls.</p>
</div>
<div className="key-feature-item">
<h4>📊 Health Monitoring</h4>
<p>Track your health metrics and receive personalized recommendations for a 
healthier lifestyle.</p>
</div>
<div className="key-feature-item">
<h4>🔒 Secure Digital Records</h4>
<p>Access your medical history, prescriptions, and reports anytime on our secure 
platform.</p>
</div>
</div>
</div>
...
<p>
<a href="/terms" style={{ color: '#007BFF', textDecoration: 'none' }}>Terms of 
Service</a> |{' '}
<a href="/privacy" style={{ color: '#007BFF', textDecoration: 'none' }}>Privacy 
Policy</a>
</p>
</div>
</footer>
